...
import 'package:weather_clean_architecture/weather/data/repositery/weather_repository.dart';
...
import 'package:weather_clean_architecture/weather/domain/usecases/get_weather_by_country.dart';

void main() async{
  BaseRemoteDataSource remoteDataSource = RemoteDataSource() ;
  BaseWeatherRepository repositery = WeatherRepository(remoteDataSource);
  Weather weather = await GetWeatherByCityName(repositery).excute("Egypt") ;
  print(weather) ;
  runApp(const MyApp());
}
